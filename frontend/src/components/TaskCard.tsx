...
export default function TaskCard({ task, onMoveTask, onDelete }: Props) {
  return (
    <div className=" rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
      <div className="flex justify-end gap-1">
        <button
          onClick={() => onMoveTask(task)}
          className="cursor-pointer rounded p-1.5 text-gray-500 hover:bg-gray-100 hover:text-blue-600"
